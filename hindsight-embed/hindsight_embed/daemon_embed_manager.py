...
def _detach_popen_kwargs(log_handle) -> dict:
    ...
    if platform.system() == "Windows":
        # Windows-only constants; use getattr so type checkers running on
        # Linux don't flag the attribute access. Guaranteed present at runtime
        # because of the platform.system() guard above.
